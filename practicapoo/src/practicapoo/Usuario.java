...
public class Usuario implements Serializable{
    ...
    //METODOS
    /* invitar amigos(Usuario u)
       aceptarInvitacion(Usuario u)
       rechazarInvitacion(Usuario u)
       compartirPelicula(Pelicula p)
       compartirPelicula(Pelicula p,Usuario U)
       compartirCritica(Critica c)
       compartirCritica(Critica c)
       compartirPartida(Partida p)
       compartirPartida(Partida p,Usuario u)
       compartirTodo()
       compartirTodo(Usuario u)
       añadirPelicula(Pelicula p)
       añadirCritica(Critica c,Pelicula p)
       iniciarPartida(Usuario u)
       completarPartida(Partida p)
    */
    //METODOS ADICIONALES
    
    public boolean EsSolicitudes_PendientesVacia(){
        return this.solicitudes_amigos_pendientes.isEmpty();
    }
    
    public boolean EsLista_AmigosVacia(){
        return this.lista_amigos.isEmpty();
    }
    
    public boolean EsListaPartidas_PendientesVacia(){
        return this.partidas_pendientes.isEmpty();
    }
    
    public boolean EsListaPartidas_CompletasVacia(){
        return this.partidas_completas.isEmpty();
    }
    
    public Usuario copiaUsuario(){ 
